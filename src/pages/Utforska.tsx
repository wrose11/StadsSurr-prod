...
const Utforska = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-6">
          <h1 className="text-3xl font-bold mb-2">Utforska Stockholm</h1>
          <p className="text-muted-foreground mb-4">
          <span className="text-[#2A81CB] font-semibold">Blå markörer</span> = Stockholms stad projekt &nbsp; | &nbsp;
          <span className="text-[#3FBF3F] font-semibold">Gröna markörer</span> = Användar inlägg
          </p>
